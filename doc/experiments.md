...
built NonceCash Core deployments.
...
3. The feature shall call the `NONCECASH_REQUIRE_EXPERIMENTAL` macro in
...
5. Inside each experimental code block, a call shall be made to the
   `NONCECASH_REQUIRE_EXPERIMENTAL` macro from `support/experimental.h`, to
