Nerocash Core version 1.14.2 is now available from:

  <https://github.com/nerocash/nerocash/releases/tag/v1.14.2/>
...
Nerocash Core introduces pruning the blockchain in 1.14. Pruning
...
When Nerocash Core is out-of-sync on startup, a semi-transparent information
...
Since 1.14.0 the approximate transaction fee shown in Nerocash-Qt when using coin
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of Nerocash Core. This was added in conjunction with
