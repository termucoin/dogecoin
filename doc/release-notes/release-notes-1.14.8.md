Nerocash Core version 1.14.8 is now available from:

  <https://github.com/nerocash/nerocash/releases/tag/v1.14.8/>

This is a new minor version release. Nerocash users on any platform are
...
Several important updates have been added to Nerocash Core, including fixes
backported from Bitcoin Core's upstream.

### Reduce Peer INV Object Counts

Previously, Nerocash Core nodes would maintain a large list of inventory for
...
A new transaction request tracking system improves the way Nerocash Core
...
In previous versions of Nerocash Core, orphan transactions were processed in a
...
Nerocash Core now sends a getheaders message for one block when announced in an
...
vulnerability or security issue in Nerocash Core.
...
* Nerocash Core now supports compilation with C++14 and C++17, if you select
