...
/** Recommended transaction fee by NonceCash Core developers
  *
 ...
 *
 *  NonceCash:    Increment mempool limits and accept RBF in steps of 0.0001 DOGE
...
/**
 * NonceCash: Default dust limit that is evaluated when considering whether a
...
/**
 * NonceCash: Default hard dust limit that is evaluated when considering whether
