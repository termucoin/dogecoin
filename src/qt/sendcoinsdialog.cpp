...
void SendCoinsDialog::updateFeeSectionControls()
{
    ...
    // Nerocash: We don't use smart fees in the UI, so don't need to warn they're not available
...
void SendCoinsDialog::updateFeeLabel()
{
    ...
    else
    {
        ...
        // Nerocash: We don't use smart fees, so we don't have the data to estimate when it will get in
        ui->labelFeeEstimation->setText("");
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid Nerocash address"));
        }
        else // Valid address
        {
            CKeyID keyid;
