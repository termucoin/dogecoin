...
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_DIR/noncecash.conf}
...
then
  ...
  echo -e "To safely generate a noncecash.conf file, please commit your changes to $NONCECASHD, rebuild, then run this script again.\n"
fi

echo 'Generating example noncecash.conf file in share/'
...
##
## noncecash.conf configuration file.
## Generated by contrib/devtools/gen-noncecash-conf.sh.
##
